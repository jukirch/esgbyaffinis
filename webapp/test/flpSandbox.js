			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esgapp-display": {
								"semanticObject": "esgapp",
								"action": "display",
								"description": "ESG App by affinis",
								"title": "ESG App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=esgapp",
									"url": sap.ui.require.toUrl("esgapp")
								}
							}
						}
					}
